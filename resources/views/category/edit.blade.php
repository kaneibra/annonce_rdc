@extends('layouts.app')
@section('title','Creation De Category')
@section('content')
          ...
          <section class="breedcrumb" style="background: url('assets/images/bg/bg-04.jpg') center center/cover no-repeat;">
            <div class="container">
                ...
                <ul class="breedcrumb__page">
                    ...
                    <li class="breedcrumb__page-item">
                        <a href="#" class="breedcrumb__page-link text--body-3">Edit category</a>
                    </li>
                </ul>
            </div>
        </section>
                            ...
                            <ul class="nav dashboard-post__nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item dashboard-post__item" role="presentation">
                                    <div class="nav-link dashboard-post__link" id="pills-advance-tab" data-bs-toggle="pill" data-bs-target="#pills-advance" role="tab" aria-controls="pills-advance" aria-selected="false">
                                        ...
                                        <div class="step-info">
                                            <h2 class="text--body-3-600"> Edit Category</h2>
                                            <p class="text--body-4">Name,  & Icon</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="nav-item dashboard-post__item" role="presentation">
                                    ...
                                    <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        @method('PUT')
                                          <div class="dashboard-post__step02 step-information">
                                            ...
                                            <input  id="name" ype="text" name="name" required value="{{$category->name}}">
                                            ...
                                            <div class="upload-area">
                                                ...
                                                <div class="add-new">
                                                    <input type="file" class="form-control filter-input" name="icon" placeholder="864 W. Walnut Ave. Avon, IN 46123 St James Pl, Brooklyn">
                                                    @if (!is_null($category->icon))
                                                    <img src="{{ asset($category->icon) }}" alt="" width="100" style="margin-top: 30px">
                                               @endif
                                                </div>
                                            </div>
                                        </div>
