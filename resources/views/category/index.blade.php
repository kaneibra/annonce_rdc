                        ...
                        <div class="blog-list__wrapper-item">
                            <div class="blog-card">
                                ...
                                <div class="blog-card__right">
                                    ...
                                    <a href="{{route('category.edit',encrypt($category->id))}}" class="blog-card__readmore">
                                        Edit
                                        <span class="icon">
                                    ...
                                    <form id="{{$category->id}}" action="{{route('category.destroy', $category->id)}} " method="POST">
                                        @csrf
                                        @method("DELETE")

                                       <button  style="transform: translateX(-20%)" onclick="event.preventDefault(); if(confirm('Voulez vous supprimer la catégorie {{$category->name}} ?')) document.getElementById({{$category->id}}).submit()" class="btn v5"><i class="ion-android-delete"></i> Supprimer</button>
