            ...
            <div class="row">
                <div class="col-xl-3">
                    <div class="footer__brand-logo">
                        <h4 style="position: absolute; top:8px;right:1px;transform:translateX(-60px)">{{config('app.name')}}</h4>
                        <img src="{{asset('assets/images/logo.png')}}"  style="height:50px;width:50px; border:1px;border-radius:15%" alt="logo-brand" />
                    </div>
                ...
                <div class="col-xl-2 col-lg-2 col-sm-4 col-6">
                    ...
                    <ul class="footer-menu">
                        {{-- @foreach ($cats as $cat)
                        <li class="footer-menu__item">
                            <a href="#" class="footer-menu__link text--body-3">{{$cat->name}}</a>
                        </li>
                        @endforeach --}}
