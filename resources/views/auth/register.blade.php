...
{{-- <div class="container">
 ...
 <section class="breedcrumb" style="background: url('assets/images/bg/bg-04.jpg') center center/cover no-repeat;">
    <div class="container">
        <h2 class="breedcrumb__title text--heading-2">Sign Up</h2>
        <ul class="breedcrumb__page">
            ...
            <li class="breedcrumb__page-item">
                <a href="#" class="breedcrumb__page-link text--body-3">Sign Up</a>
            </li>
        </ul>
    </div>
</section>
                        ...
                        <form action="{{route('register')}}" method="POST">
                            ...
                            <div class="input-field__group">
                                <div class="input-field">
                                    <input id="firstName" type="text"  class="form-control @error('fisrtName') is-invalid @enderror" name="firstName" value="{{ old('firstName') }}" placeholder="Prénom" required autocomplete="firstName"/>
                                    @error('firstName')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="input-field">
                                    <input id="lastName" type="text"  class="form-control @error('lastName') is-invalid @enderror" name="lastName" value="{{ old('lastName') }}" placeholder="Nom" required autocomplete="lastName" />
                                    @error('lastName')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-field">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder=" email address" />
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="input-field">
                                <input id="password" type="password"  class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" required autocomplete="password" placeholder="Password" id="password" />
                            ...
                            <p class="text--body-3 registration-form__redirect">Already Have an Account ? <a href="signin.html">Sign In</a></p>
                        </form>
                    </div>
                </div>
            </div>
